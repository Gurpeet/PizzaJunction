...
exports.RouteConfig = [
    ...
    { path: 'delivery-address/:orderType', loadChildren: '/app/delivery-address/delivery-address.module#DeliveryAddressModule', data: { orderType: global_1.orderType.Delivery } },
